 ...
 */
(function(g){function h(a){var b,c,d,e,f;b=a.kapi;c=a.$container.find(".rekapi-scrubber-play");d=a.$container.find(".rekapi-scrubber-pause");e=a.$container.find(".rekapi-scrubber-stop");f=a.$timeline;c.on("click",function(a){a.preventDefault();b.play()});d.on("click",function(a){a.preventDefault();b.pause()});e.on("click",function(a){a.preventDefault();b.stop(!0)});b.bind("playStateChange",function(){a.syncPlayStateButtons()});b.bind("stop",function(){a.resetScrubber()});b.bind("frameRender",function(){a.updateScrubber()});
