...
function(){return this.context.getContext("2d")};i.prototype.redraw=function(){a.bind(g,this)(this._lastUpdatedMillisecond);return this};i.prototype.moveActorToLayer=function(d,e){if(e<this._drawOrder.length)return this._drawOrder=a.without(this._drawOrder,d.id),this._drawOrder.splice(e,0,d.id),d};i.prototype.setOrderFunction=function(a){this._drawOrderSorter=a;return this};i.prototype.unsetOrderFunction=function(){this._drawOrderSorter=null;return this};i.prototype.exportTimeline=function(){var d=
{duration:this._animationLength,actorOrder:this._drawOrder.slice(0),actors:{}};a.each(this._drawOrder,function(a){d.actors[a]=this._actors[a].exportTimeline()},this);return d}},v=function(e,a){function d(){}var f=e.Kapi;d.prototype=f.Actor.prototype;var g=f.CanvasActor=function(d){f.Actor.call(this,d);d=d||{};a.extend(this,{draw:d.draw||t});return this};g.prototype=new d;g.prototype.context=function(a){a&&(this._context=a);return this._context&&this._context.getContext("2d")};g.prototype.moveToLayer=
function(a){return this.kapi.moveActorToLayer(this,a)}},w=function(e,a){function d(){}var f=e.Kapi,g=["transform","webkitTransform","MozTransform","oTransform","msTransform"];f.DOMActor=function(a){f.Actor.call(this);this._context=a;a=this.getCSSName();this._context.className.match(a)||(this._context.className+=" "+a);delete this.update;delete this.teardown;return this};d.prototype=f.Actor.prototype;f.DOMActor.prototype=new d;d.prototype.update=function(d,e){a.each(e,function(e,f){"transform"===f?
a.each(g,function(a){d.style[a]=e},this):d.style[f]=e},this)};d.prototype.teardown=function(){var d=this._context.className.match(/\S+/g);this._context.className=a.without(d,this.getCSSName())};d.prototype.getCSSName=function(){return"actor-"+this.id}},x=function(e,a){function d(d){var e=["{"],f;a.each(d.get(),function(a,d){f=a;var b=d;"transform"===d&&(b=i);e.push(b+":"+f+";")});e.push("}");return e.join("")}function f(d,e,f){var f=f||["w3"],c=[];a.each(f,function(a){a=k(q,[l[a],e,d]).replace(RegExp(i,
"g"),l[a]+"transform");c.push(a)});return c.join("\n")}function g(d,e){var e=e||["w3"],f=[],c;a.each(e,function(a){var b=[],a=l[a],e=d.getStart(),g=d.getEnd()-e,g=k("  %sanimation-duration: %sms;",[a,g]);b.push(g);g=k("  %sanimation-name: %s;",[a,d.getCSSName()+"-keyframes"]);b.push(g);e=k("  %sanimation-delay: %sms;",[a,e]);b.push(e);a=k("  %sanimation-fill-mode: forwards;",[a]);b.push(a);c=b.join("\n");f.push(c)});return k(p,[d.getCSSName(),f.join("\n")])}var h=e.Kapi,i="TRANSFORM",l=h.util.VENDOR_PREFIXES=
{microsoft:"-ms-",mozilla:"-moz-",opera:"-o-",w3:"",webkit:"-webkit-"},q="@%skeyframes %s-keyframes {\n%s\n}",p=".%s {\n  position: absolute;\n%s\n}";e.Kapi.prototype.toCSS=function(d){var d=d||{},e=[],f=this.getActorIds();a.each(f,function(a){e.push(this.getActor(a).toCSS(d))},this);return e.join("\n")};e.Kapi.Actor.prototype.toCSS=function(a){var a=a||{},e=[],j=a.granularity||100,c=g(this,a.vendors);e.push(c);var c=this.getLength(),i=this.getStart(),b=[],h,j=c/j,l=c/100,k=i+j,n=c+i-j;this.calculatePosition(i);
for(b.push("  from "+d(this));k<=n;k+=j)this.calculatePosition(k),h=(k-i)/l,h=+h.toFixed(2),h+="% ",b.push("  "+h+d(this));this.calculatePosition(c+i);b.push("  to "+d(this));c=b.join("\n");a=f(c,this.getCSSName(),a.vendors);e.push(a);return e.join("\n")};var k=h.util.printf=function(d,e){var f=d;a.each(e,function(a){f=f.replace("%s",a)});return f}},y=function(e,a){var d=a?{}:e,f=a&&a.underscore?a.underscore:d._,g=a&&a.Tweenable?a.Tweenable:d.Tweenable;z(d,f,g);A(d,f,g);B(d,f,g);"function"===typeof w&&
w(d,f,g);"function"===typeof x&&x(d,f,g);"function"===typeof u&&u(d,f,g);"function"===typeof v&&v(d,f,g);return d.Kapi};if("function"===typeof define&&define.amd){var C="undefined"!==typeof _;define(["shifty","underscore"],function(e,a){var d={Tweenable:e,underscore:null!==a?a:_},f=y(s,d);"undefined"!==typeof KAPI_DEBUG&&!0===KAPI_DEBUG&&(f.underscore_version=d.underscore.VERSION);C||(s._=void 0);return f})}else y("undefined"!==typeof s?s:this)})(this);
