...
this.draw();this._lastRenderedMillisecond=b;a(this,"onFrameRender");return this};d.prototype.redraw=function(){this.render(this._lastRenderedMillisecond);return this};d.prototype.calculateActorPositions=function(b){var a,c;c=this._drawOrder.length;for(a=0;a<c;a++)this._actors[this._drawOrder[a]].calculatePosition(b);return this};d.prototype.draw=function(){var a,c,d,g;this.canvas_clear();c=this._drawOrder.length;g=this.canvas_getContext();for(a=0;a<c;a++)d=this._actors[this._drawOrder[a]],d.isShowing()&&
d.draw(g,d.get());return this};d.prototype.updateInternalState=function(){var a=[];_.each(this._actors,function(c){a.push(c.getEnd())});this._animationLength=Math.max.apply(Math,a);return this};d.prototype.moveActorToLayer=function(a,c){if(c<this._drawOrder.length)return this._drawOrder=_.without(this._drawOrder,a.id),this._drawOrder.splice(c,0,a.id),a};d.prototype.bind=function(a,c){if(this._events[a])return this._events[a].push(c),this};d.prototype.unbind=function(a,c){if(this._events[a])return this._events[a]=
c?_.without(this._events[a],c):[],this};d.prototype.exportTimeline=function(){var a={duration:this._animationLength,actorOrder:this._drawOrder.slice(0),actors:{}};_.each(this._drawOrder,function(c){a.actors[c]=this._actors[c].exportTimeline()},this);return a};d.util={};_.extend(d.util,{noop:function(){},sortNumerically:j,calculateLoopPosition:n,calculateTimeSinceStart:i});if("undefined"!==typeof KAPI_DEBUG&&!0===KAPI_DEBUG)d._private={sortNumerically:j,calculateLoopPosition:n,renderCurrentMillisecond:h,
tick:m,determineCurrentLoopIteration:e,calculateTimeSinceStart:i,isAnimationComplete:k,updatePlayState:l};f.Kapi=d})(this);
