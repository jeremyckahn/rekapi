 ...
 * MIT Lincense.  This code free to use, modify, distribute and enjoy.
 */
(function(r){var y=function(g,a,d){function k(b,c){return Math.floor(c/b._animationLength)}function i(b){return c()-b._loopTimestamp}function l(b,c){return c>=b._timesToIterate&&-1!==b._timesToIterate}function j(b,c){l(b,c)&&(b.stop(),m(b,"onAnimationComplete"))}function q(b,c,f){return l(b,f)?b._animationLength:c%b._animationLength}function n(b){var c=i(b),f=k(b,c),c=q(b,c,f);b.render(c);j(b,f)}function o(b){var c=function(){o(b);n(b)};b._loopId=b._scheduleUpdate.call?b._scheduleUpdate.call(d,c,
...
m(this,"onBeforeDraw");var c=this._drawOrder.length,f;this._drawOrderSorter?(f=e.sortBy(this._actors,this._drawOrderSorter),f=e.pluck(f,"id")):f=this._drawOrder;for(var a,d,j=0;j<c;j++)a=this._actors[f[j]],d=a.context(),a.render(d,a.get());this._lastRenderedMillisecond=b;m(this,"onFrameRender");return this};a.prototype.redraw=function(){this.render(this._lastRenderedMillisecond);return this};a.prototype.calculateActorPositions=function(b){for(var c=this._drawOrder.length,f=0;f<c;f++)this._actors[this._drawOrder[f]].calculatePosition(b);
