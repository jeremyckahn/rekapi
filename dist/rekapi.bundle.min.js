...
d.util={};g.extend(d.util,{noop:function(){},sortNumerically:c,calculateLoopPosition:o,calculateTimeSinceStart:m});if("undefined"!==typeof KAPI_DEBUG&&!0===KAPI_DEBUG)d._private={sortNumerically:c,calculateLoopPosition:o,renderCurrentMillisecond:i,tick:p,determineCurrentLoopIteration:l,calculateTimeSinceStart:m,isAnimationComplete:n,updatePlayState:k};h.Kapi=d},w=function(h,f){function c(a,e){var d,b,g;g=a._timelinePropertyCacheIndex;b=g.length;for(d=1;d<b;d++)if(g[d]>=e)return d-1;return-1}function l(a){g.each(a._propertyTracks,
function(e,d){a._propertyTracks[d]=g.sortBy(a._propertyTracks[d],function(a){return a.millisecond})})}function m(a){g.each(a._timelinePropertyCaches,function(e,d){var b={};g.each(a._propertyTracks,function(a,e){var c=null;g.find(a,function(a){a.millisecond>d&&(b[e]=c);c=a;return!!b[e]})});g.defaults(e,b)})}function n(a){g.each(a._propertyTracks,function(a){g.each(a,function(d,b){d.linkToNext(a[b+1])})})}function k(a,e,d){return g.find(a._propertyTracks[e],function(a){return a.millisecond===d})}function o(a,
e,d,b){var c=g.keys(a._propertyTracks),f=g.keys(e),c=g.difference(c,f),i={};g.each(c,function(d){var e;e=a._propertyTracks[d].slice(0).reverse();g.each(e,function(a){a.millisecond<b&&!i[d]&&(i[d]={value:a.value,easing:a.easing})})});g.each(i,function(a,b){e[b]=a.value;d[b]=a.easing})}var i,p,j,g=f&&f.underscore?f.underscore:h._,q=f&&f.Tweenable?f.Tweenable:h.Tweenable;i=h.Kapi;p=0;i.Actor=function(a){a=a||{};this.constructor.call(this);g.extend(this,{_data:{},_propertyTracks:{},_timelinePropertyCaches:{},
