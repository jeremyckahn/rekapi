 ...
 * MIT Lincense.  This code free to use, modify, distribute and enjoy.
 */
(function(t){var z=function(j,c){function f(d){return d.sort(function(d,a){return d-a})}function l(d,a){return Math.floor(a/d._animationLength)}function n(d){return g()-d._loopTimestamp}function p(d,a){return a>=d._timesToIterate&&-1!==d._timesToIterate}function q(d,a){p(d,a)&&(d.stop(),o(d,"onAnimationComplete"))}function m(d,a,b){return p(d,b)?d._animationLength:a%d._animationLength}function e(d){var a=n(d),b;b=l(d,a);a=m(d,a,b);d.render(a);q(d,b)}function r(a){a._loopId=a._scheduleUpdate.call(window,
function(){r(a);e(a)},1E3/a.config.fps)}function o(d,b){a.each(d._events[b],function(a){a(d)})}function i(a){return 60!==a?window.setTimeout:window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||window.mozCancelRequestAnimationFrame&&window.mozRequestAnimationFrame||window.setTimeout}function s(a){return 60!==a?window.clearTimeout:window.cancelAnimationFrame||window.webkitCancelAnimationFrame||window.oCancelAnimationFrame||
window.msCancelAnimationFrame||window.mozCancelRequestAnimationFrame||window.clearTimeout}var a=c&&c.underscore?c.underscore:j._,b=c&&c.Tweenable?c.Tweenable:j.Tweenable,g=b.util.now,k={fps:60,doRoundNumbers:!1,clearOnUpdate:!0},h=j.Kapi||function(d){this.config=d||{};this.context=this.config.context;this._actors={};this._drawOrder=[];this._playState="stopped";this._drawOrderSorter=null;this._events={onFrameRender:[],onAnimationComplete:[],onPlayStateChange:[],onPlay:[],onPause:[],onStop:[],onBeforeDraw:[]};
this._timesToIterate=-1;this._animationLength=0;this._pausedAtTime=this._loopTimestamp=this._loopId=null;this._lastRenderedMillisecond=0;a.extend(this.config,d);a.defaults(this.config,k);this._scheduleUpdate=i(this.config.fps);this._cancelUpdate=s(this.config.fps);a.each(this._contextInitHook,function(a){a.call(this)},this);return this};h.prototype._contextInitHook={};h.prototype._recalculateAnimationLength=function(){var d=[];a.each(this._actors,function(a){d.push(a.getEnd())});this._animationLength=
Math.max.apply(Math,d);return this};h.prototype.addActor=function(d){if(!a.contains(this._actors,d))d.context()||d.context(this.context),d.kapi=this,d.fps=this.framerate(),this._actors[d.id]=d,this._drawOrder.push(d.id),d.setup();return this};h.prototype.getActor=function(a){return this._actors[a]};h.prototype.getActorIds=function(){return a.pluck(this._actors,"id")};h.prototype.getAllActors=function(){return a.clone(this._actors)};h.prototype.removeActor=function(d){delete this._actors[d.id];delete d.kapi;
this._drawOrder=a.without(this._drawOrder,d.id);d.teardown();this._recalculateAnimationLength();return this};h.prototype.play=function(d){this._cancelUpdate.call(window,this._loopId);this._loopTimestamp="paused"===this._playState?this._loopTimestamp+(g()-this._pausedAtTime):g();this._timesToIterate=d||-1;this._playState="playing";r(this);a.each(this._actors,function(a){a._state.isPaused&&a.resume()});o(this,"onPlayStateChange");o(this,"onPlay");return this};h.prototype.playFrom=function(a,b){this.play(b);
...
function(b){if(b.length)b=i.last(b).millisecond,b>a&&(a=b)},this);return a};e.Actor.prototype.getLength=function(){return this.getEnd()-this.getStart()};e.Actor.prototype.modifyKeyframe=function(a,b,g){g=g||{};i.each(this._propertyTracks,function(e,h){var d=q(this,h,a);d&&d.modifyWith({value:b[h],easing:g[h]})},this);return this};e.Actor.prototype.removeKeyframe=function(a){i.each(this._propertyTracks,function(b){var g=-1;i.find(b,function(b){g++;return a===b.millisecond});(b=b.splice(g,1)[0])&&delete this._keyframeProperties[b.id]},
this);this.kapi._recalculateAnimationLength();this.invalidatePropertyCache();return this};e.Actor.prototype.removeAllKeyframeProperties=function(){i.each(this._propertyTracks,function(a){a.length=0},this);this._keyframeProperties={};return this.removeKeyframe(0)};e.Actor.prototype.moveToLayer=function(a){return this.kapi.moveActorToLayer(this,a)};e.Actor.prototype.show=function(a){this._isShowing=!0;this._isPersisting=!!a;return this};e.Actor.prototype.hide=function(a){this._isShowing=!1;if(!0===
a)this._isPersisting=!1;return this};e.Actor.prototype.isShowing=function(){return this._isShowing||this._isPersisting};e.Actor.prototype.calculatePosition=function(a){var b,g,e;b=this.getStart();g=this.getEnd();this.hide();b<=a&&a<=g&&(this.show(),b=f(this,a),b=this._timelinePropertyCaches[this._timelinePropertyCacheIndex[b]],e={},i.each(b,function(b,d){e[d]=b.getValueAt(a)}),this.set(e));return this};e.Actor.prototype.data=function(a){if(a)this._data=a;return this._data};e.Actor.prototype.exportTimeline=
function(){var a={start:this.getStart(),end:this.getEnd(),trackNames:this.getTrackNames(),propertyTracks:{}};i.each(this._propertyTracks,function(b,g){var e=a.propertyTracks[g]=[];i.each(b,function(a){e.push(a.exportPropertyData())})});return a};e.Actor.prototype.invalidatePropertyCache=function(){this._timelinePropertyCaches={};i.each(this._keyframeProperties,function(a){this._timelinePropertyCaches[a.millisecond]||(this._timelinePropertyCaches[a.millisecond]={});this._timelinePropertyCaches[a.millisecond][a.name]=
a},this);this._timelinePropertyCacheIndex=i.keys(this._timelinePropertyCaches);i.each(this._timelinePropertyCacheIndex,function(a,b){this._timelinePropertyCacheIndex[b]=+a},this);e.util.sortNumerically(this._timelinePropertyCacheIndex);n(this);p(this)};i.each(["tween","to"],function(a){e.Actor.prototype[a]=function(){this.show(!0);s.prototype[a].apply(this,arguments)}},this)},B=function(j,c){var f,l=c&&c.underscore?c.underscore:j._,n=c&&c.Tweenable?c.Tweenable:j.Tweenable;f=j.Kapi;f.KeyframeProperty=
function(c,f,m,e,j){this.id=l.uniqueId("keyframeProperty_");this.ownerActor=c;this.millisecond=f;this.name=m;this.value=e;this.easing=j||"linear";this.nextProperty=null;return this};f.KeyframeProperty.prototype.modifyWith=function(c){var f={};l.each(["millisecond","easing","value"],function(m){f[m]="undefined"===typeof c[m]?this[m]:c[m]},this);l.extend(this,f)};f.KeyframeProperty.prototype.linkToNext=function(c){this.nextProperty=c||null};f.KeyframeProperty.prototype.getValueAt=function(c){var f,
...
"function"===typeof u&&u(f,c);"function"===typeof v&&v(f,c);return f.Kapi};if("function"===typeof define&&define.amd){var C="undefined"!==typeof _;define(["shifty","underscore"],function(j,c){var f={Tweenable:j,underscore:null!==c?c:_},l=y(t,f);if("undefined"!==typeof KAPI_DEBUG&&!0===KAPI_DEBUG)l.underscore_version=f.underscore.VERSION;C||delete t._;return l})}else y("undefined"!==typeof t?t:this)})(this);
