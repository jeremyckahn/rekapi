...
this.getStart()};h.Actor.prototype.modifyKeyframe=function(a,d,g){g=g||{};_.each(this._propertyTracks,function(c,b){var e=l(this,b,a);e&&e.modifyWith({value:d[b],easing:g[b]})},this);return this};h.Actor.prototype.removeKeyframe=function(a){_.each(this._propertyTracks,function(d){var g=-1;_.find(d,function(c){g++;return a===c.millisecond});(d=d.splice(g,1)[0])&&delete this._keyframeProperties[d.id]},this);this.kapi.updateInternalState();this.invalidatePropertyCache();return this};h.Actor.prototype.removeAllKeyframeProperties=
