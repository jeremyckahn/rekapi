...
v=function(f,a){function d(){}var k=f.Kapi,j=a&&a.underscore?a.underscore:f._,m=["transform","webkitTransform","MozTransform","oTransform","msTransform"];k.DOMActor=function(a){k.Actor.call(this);this._context=a;a=this.getCSSName();this._context.className.match(a)||(this._context.className+=a);delete this.render;return this};d.prototype=k.Actor.prototype;k.DOMActor.prototype=new d;d.prototype.render=function(a,d){j.each(d,function(d,f){"transform"===f?j.each(m,function(f){a.style[f]=d},this):a.style[f]=
d},this)};d.prototype.getCSSName=function(){return"actor-"+this.id}},w=function(f,a){function d(a){var d=["{"],b;i.each(a.get(),function(a,f){b=a;var c=f;"transform"===f&&(c=o);d.push(c+":"+b+";")});d.push("}");return d.join("")}function k(a,d,b){var b=b||["w3"],e=[];i.each(b,function(b){b=l(q,[n[b],d,a]).replace(RegExp(o,"g"),n[b]+"transform");e.push(b)});return e.join("\n")}function j(a,d){var d=d||["w3"],b=[],e;i.each(d,function(d){var c=[],d=n[d],f=a.getStart(),h=a.getEnd()-f,h=l("  %sanimation-duration: %sms;",
[d,h]);c.push(h);h=l("  %sanimation-name: %s;",[d,a.getCSSName()+"-keyframes"]);c.push(h);f=l("  %sanimation-delay: %sms;",[d,f]);c.push(f);d=l("  %sanimation-fill-mode: forwards;",[d]);c.push(d);e=c.join("\n");b.push(e)});return l(g,[a.getCSSName(),b.join("\n")])}var m=f.Kapi,i=a&&a.underscore?a.underscore:f._,o="TRANSFORM",n=m.util.VENDOR_PREFIXES={microsoft:"-ms-",mozilla:"-moz-",opera:"-o-",w3:"",webkit:"-webkit-"},q="@%skeyframes %s-keyframes {\n%s\n}",g=".%s {\n  position: absolute;\n%s\n}";
f.Kapi.prototype.toCSS=function(a){var a=a||{},d=[],b=this.getActorIds();i.each(b,function(b){d.push(this.getActor(b).toCSS(a))},this);return d.join("\n")};f.Kapi.Actor.prototype.toCSS=function(a){var a=a||{},f=[],b=a.granularity||100,e=j(this,a.vendors);f.push(e);var e=this.getLength(),g=this.getStart(),c=[],i,b=e/b,m=e/100,l=g+b,n=e+g-b;this.calculatePosition(g);for(c.push("  from "+d(this));l<=n;l+=b)this.calculatePosition(l),i=(l-g)/m,i=+i.toFixed(2),i+="% ",c.push("  "+i+d(this));this.calculatePosition(e+
g);c.push("  to "+d(this));e=c.join("\n");a=k(e,this.getCSSName(),a.vendors);f.push(a);return f.join("\n")};var l=m.util.printf=function(a,d){var b=a;i.each(d,function(a){b=b.replace("%s",a)});return b}},x=function(f,a){var d=a?{}:f;y(d,a,f);z(d,a);A(d,a);"function"===typeof v&&v(d,a);"function"===typeof w&&w(d,a);"function"===typeof t&&t(d,a);"function"===typeof u&&u(d,a);return d.Kapi};if("function"===typeof define&&define.amd){var B="undefined"!==typeof _;define(["shifty","underscore"],function(f,
a){var d={Tweenable:f,underscore:null!==a?a:_},k=x(s,d);if("undefined"!==typeof KAPI_DEBUG&&!0===KAPI_DEBUG)k.underscore_version=d.underscore.VERSION;if(!B)s._=void 0;return k})}else x("undefined"!==typeof s?s:this)})(this);
