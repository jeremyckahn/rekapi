...
typeof f==="string"&&(g=f,f={},_.each(h,function(b,c){f[c]=g}));_.each(h,function(b,c){f[c]=f[c]||"linear"});this._keyframes[b]={position:h,easing:f};this._keyframeList.push(b);c.util.sortNumerically(this._keyframeList);this.kapi.updateInternalState();return this};c.Actor.prototype.liveCopy=function(b,c){var f;this._keyframes.hasOwnProperty(c)&&(f=this._keyframes[c],this.keyframe(b,f.position,f.easing));return this};c.Actor.prototype.modifyKeyframe=function(b,c,f){b=this._keyframes[b];j(b.position,
c);f&&j(b.easing,f);return this};c.Actor.prototype.removeKeyframe=function(b){if(this._keyframeList.indexOf(b)!==-1)this._keyframeList=_.without(this._keyframeList,b),delete this._keyframes[b],this.kapi.updateInternalState();return this};c.Actor.prototype.removeAllKeyframes=function(){var b;b=this._keyframeList.slice(0);_.each(b,function(b){this.removeKeyframe(b)},this);return this};c.Actor.prototype.moveToLayer=function(b){return this.kapi.moveActorToLayer(this,b)};c.Actor.prototype.show=function(b){this._isShowing=
true;this._isPersisting=!!b;return this};c.Actor.prototype.hide=function(b){this._isShowing=false;if(b===true)this._isPersisting=false;return this};c.Actor.prototype.isShowing=function(){return this._isShowing||this._isPersisting};c.Actor.prototype.calculatePosition=function(b){var c,f,g,e,d;c=this._keyframeList;f=_.first(c);g=_.last(c);this.hide();if(f<=b&&b<=g){this.show();f=this._keyframes;a:{d=this._keyframeList;e=d.length;for(g=1;g<e;g++)if(d[g]>=b){g-=1;break a}g=-1}e=c[g];d=c[g+1];this.set(f[c[g]].position).interpolate(f[c[g+
