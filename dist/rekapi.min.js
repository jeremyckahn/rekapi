...
d.clearTimeout}function h(c){c._cancelUpdate.call?c._cancelUpdate.call(d,c._loopId):clearTimeout(c._loopId)}var b=a&&a.underscore?a.underscore:f._,e=(a&&a.Tweenable?a.Tweenable:f.Tweenable).util.now,r={fps:60},a=f.Kapi||function(c){this.config=c||{};this.context=this.config.context;this._actors={};this._drawOrder=[];this._playState="stopped";this._drawOrderSorter=null;this._events={onFrameRender:[],onAnimationComplete:[],onPlayStateChange:[],onPlay:[],onPause:[],onStop:[],onBeforeDraw:[]};this._timesToIterate=
