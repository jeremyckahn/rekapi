...
c.draw(e,c.get());return this};e.prototype.updateInternalState=function(){var b=[];_.each(this._actors,function(a){b.push(a.getEnd())});this._animationLength=Math.max.apply(Math,b);return this};e.prototype.moveActorToLayer=function(a,c){if(c<this._drawOrder.length)return this._drawOrder=_.without(this._drawOrder,a.id),this._drawOrder.splice(c,0,a.id),a};e.prototype.bind=function(a,c){if(this._events[a])return this._events[a].push(c),this};e.prototype.unbind=function(a,c){if(this._events[a])return this._events[a]=
...
n(this,c,g,a);_.each(c,function(b,c){var e;e=new i.KeyframeProperty(this,a,c,b,g[c]);this._keyframeProperties[e.id]=e;this._propertyTracks[c]||(this._propertyTracks[c]=[]);this._propertyTracks[c].push(e);d(this)},this);this.kapi.updateInternalState();this.invalidatePropertyCache();return this};i.Actor.prototype.modifyKeyframeProperty=function(a,c,g){this._propertyTracks[a]&&this._propertyTracks[a][c]&&this._propertyTracks[a][c].modifyWith(g);d(this);this.invalidatePropertyCache();return this};i.Actor.prototype.copyProperties=
function(a,c){var g,e;g={};e={};_.each(this._propertyTracks,function(a,d){var h;if(h=l(this,d,c))g[d]=h.value,e[d]=h.easing},this);this.keyframe(a,g,e);return this};i.Actor.prototype.wait=function(a){var c=this.getEnd();if(!(a<=c))return this.copyProperties(a,c),this};i.Actor.prototype.getStart=function(){var a=[];_.each(this._propertyTracks,function(c){c.length&&a.push(c[0].millisecond)});0===a.length&&(a=[0]);return Math.min.apply(Math,a)};i.Actor.prototype.getEnd=function(){var a=0;_.each(this._propertyTracks,
function(c){if(c.length)c=_.last(c).millisecond,c>a&&(a=c)},this);return a};i.Actor.prototype.modifyKeyframe=function(a,c,g){g=g||{};_.each(this._propertyTracks,function(e,b){var d=l(this,b,a);d&&d.modifyWith({value:c[b],easing:g[b]})},this);return this};i.Actor.prototype.removeKeyframe=function(a){_.each(this._propertyTracks,function(c){var d=-1;_.find(c,function(c){d++;return a===c.millisecond});(c=c.splice(d,1)[0])&&delete this._keyframeProperties[c.id]},this);this.kapi.updateInternalState();this.invalidatePropertyCache();
return this};i.Actor.prototype.removeAllKeyframeProperties=function(){_.each(this._propertyTracks,function(a){a.length=0},this);this._keyframeProperties={};return this.removeKeyframe(0)};i.Actor.prototype.moveToLayer=function(a){return this.kapi.moveActorToLayer(this,a)};i.Actor.prototype.show=function(a){this._isShowing=!0;this._isPersisting=!!a;return this};i.Actor.prototype.hide=function(a){this._isShowing=!1;if(!0===a)this._isPersisting=!1;return this};i.Actor.prototype.isShowing=function(){return this._isShowing||
this._isPersisting};i.Actor.prototype.calculatePosition=function(a){var c,d,e;c=this.getStart();d=this.getEnd();this.hide();c<=a&&a<=d&&(this.show(),c=j(this,a),c=this._timelinePropertyCaches[this._timelinePropertyCacheIndex[c]],e={},_.each(c,function(b,c){e[c]=b.getValueAt(a)}),this.set(e));return this};i.Actor.prototype.data=function(a){if(a)this._data=a;return this._data};i.Actor.prototype.invalidatePropertyCache=function(){this._timelinePropertyCaches={};_.each(this._keyframeProperties,function(a){this._timelinePropertyCaches[a.millisecond]||
(this._timelinePropertyCaches[a.millisecond]={});this._timelinePropertyCaches[a.millisecond][a.name]=a},this);this._timelinePropertyCacheIndex=_.keys(this._timelinePropertyCaches);_.each(this._timelinePropertyCacheIndex,function(a,c){this._timelinePropertyCacheIndex[c]=+a},this);i.util.sortNumerically(this._timelinePropertyCacheIndex);h(this);k(this)};_.each(["tween","to"],function(a){i.Actor.prototype[a]=function(){this.show(!0);Tweenable.prototype[a].apply(this,arguments)}},this)})(this);
